                    ...
                    <div class="msg-body">
                        <ul>
                            ...
                            <template v-for="message in dataConversation" :key="message.dataConversation">
                                <li
                                    :class="{'sender': message.dataMessage.type === 1, 'reply': message.dataMessage.type === 0}">
                                            ...
                                            <template v-if="message.dataMessage.type === 1">
                                                <div class="col-4 flex-row-reverse actions">
                                                    <button title="Make unseen" class="btn btn-sm mr-10"
                                                        ...
                                                        <span v-if="message.dataMessage.is_provider_seen === true">Make unseen</span>
                                                    </button>
...
export default {
    ...
    methods: {
        ...
        sendFile() {
            ...
            formData.append('receiverId', this.selectedConversation.seeker_id);
        ...
        sendMessage() {
            ...
            axios.post('/provider-conversation/send-message', formData)
                .then((response) => {
                    const newMessage = {
        ...
        deleteValue(value) {
            const conversationMessageRef = db.collection('conversation_message').doc(value.dataMessage.id);
...
console.log(value.dataMessage.id)
