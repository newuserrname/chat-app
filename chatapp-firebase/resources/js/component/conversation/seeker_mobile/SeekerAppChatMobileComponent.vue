...
import ChatBox from "./SeekerChatMobileBox.vue";
import axios from "axios";
export default {
    name: "SeekerAppChatMobileComponent",
    components: {
        ChatBox,
    },
    props: {
    ...
    methods: {
        ...
        getChatList() {
            axios.get("/seeker-conversation/chatlist/")
                .then(response => {
    ...
    created() {
        db.collection('conversation').where('seeker_id', '==', this.currentId)
